...
import com.sandcastle.api.composite.product.ProductAggregate;
import com.sandcastle.api.composite.product.RecommendationSummary;
import com.sandcastle.api.composite.product.ReviewSummary;
...
class ProductCompositeApplicationTests {
	...
	@Test
	void canCreateCompositeProductWithoutReviewAndRecommendation() {
	...
	@Test
	void canCreateCompositeProductWithReviewAndRecommendation() {
	...
	@Test
	void canDeleteCompositeProduct() {
		ProductAggregate compositeProduct = new ProductAggregate(1, "name", 1,
				singletonList(new RecommendationSummary(1, "a", 1, "c")),
				singletonList(new ReviewSummary(1, "a", "s", "c")), null);
	...
	@Test
	void verifyGetProductInvalidInput() {
